...
for div in range (1,4):
    ...
    df_stats["#"] = df_stats[['MR','MW','PR','PF']].apply(tuple,axis=1)\
        .rank(method='min',ascending=False).astype(int)
    df_stats = df_stats.sort_values("#")
    df_stats = df_stats[['#','PLAYER','MP','MW','ML','MR','PF','PA','PD','PF/M','PA/M','PD/M','PR']]
    ...
    f = open(f"/home/conner/pickleball_league2/test/stats_updatelog_d{div}.txt", "a")
